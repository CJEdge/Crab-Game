...
//     version 1.3.0
//     from Assets/Code/PlayerController.inputactions
//
    ...
    public struct PlayerControllsActions
    {
        ...
        public void SetCallbacks(IPlayerControllsActions instance)
        {
            if (m_Wrapper.m_PlayerControllsActionsCallbackInterface != null)
            {
                ...
                @UpAttack.started -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnUpAttack;
                @UpAttack.performed -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnUpAttack;
                @UpAttack.canceled -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnUpAttack;
                @SideAttack.started -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnSideAttack;
                @SideAttack.performed -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnSideAttack;
                @SideAttack.canceled -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnSideAttack;
                @DownAttack.started -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnDownAttack;
                @DownAttack.performed -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnDownAttack;
                @DownAttack.canceled -= m_Wrapper.m_PlayerControllsActionsCallbackInterface.OnDownAttack;
            }
